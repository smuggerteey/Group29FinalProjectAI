...
Original file is located at
    https://colab.research.google.com/drive/1d20jlh0hhDYxNp_gGt-eIM4-u9clZxO2
"""
...
# 
# st.header("F&T-MedBot & ChronicDiseasePredictionSystem")
# 
# # Loading the saved models
# diabetes_model = pickle.load(open('/content/drive/My Drive/AI_MedProject/diabetes_model.sav', 'rb'))
# heart_disease_model = pickle.load(open('/content/drive/My Drive/AI_MedProject/heart_disease_model.sav', 'rb'))
# parkinsons_model = pickle.load(open('/content/drive/My Drive/AI_MedProject/parkinsons_model.sav', 'rb'))
# 
